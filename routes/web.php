...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/staff/items', [StaffController::class, 'items']);
    Route::get('/staff/type', [StaffController::class, 'type']);
    Route::get('/staff/opname', [StaffController::class, 'opname']);
    Route::post('/staff/items', [StaffController::class, 'store'])->name('staff.items');
